...
void Path_Tracing_Renderer::create_scene_kernels(const std::vector<VkDescriptorSetAndBindingMappingEXT>& descriptor_mappings)
{
    path_tracing.create(output_image_heap_offset, descriptor_mappings);
}
